...
public:
	bool begin( TwoWire * wire = &Wire , uint8_t sda = 0, uint8_t scl = 26, uint8_t addr = ROVER_ADDRESS);
	void setPulse(uint8_t pos, int8_t width);
	void setAllPulse(int8_t width0, int8_t width1, int8_t width2, int8_t width3);
